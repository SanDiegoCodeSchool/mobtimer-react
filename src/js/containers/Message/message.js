...
class Message extends React.Component {
  getMessageForState(status, currentDriver) {
    ...
    if (currentDriver) {
      switch(status) {
        case "idle":
          message = "Grab the keyboard " + currentDriver + ". Don't forget to change the keyboard language.";
          break;
        case "running":
          message = "Time to write some code " + currentDriver + "! Try not to think too much.";
          break;
        case "paused":
